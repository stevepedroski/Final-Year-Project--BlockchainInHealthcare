...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $log = "$sourceUser Created $username";
        $action = "createdUser";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <li class="nav-item active">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="adminPanel.php">Back <span class="sr-only">(current)</span></a>
        </ul>
...
<div class="wrapper">
        ...
        <p>Please create a new user below, remember to let the user know their password.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Please use password with 12+ charecters</p>
            <div class="form-group">
